 ...
 */
public class ProGridAdapters extends BaseAdapter  {
  ...
  OnItemListener onItemListener;
    ...
    OnAddItem onAddItem;
    Utility utility;
    public ProGridAdapters(Context context, ArrayList<CartQuantity> _choices, OnItemListener onItemListener, OnCartListener onCartListener
...
//        }
        ...
        if(Utility.widthScreen(context)>=480) {
            Picasso.with(context).load("http://jm3eia.com/" + _choices.get(position).getPicture()).resize(100,90).into(imgProduct);
