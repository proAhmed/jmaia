...
OnChildClick onChildClick;
    public ExpandableSubListAdapter(Context context, List<CategoryParent> listDataHeader,
...
//        if (convertView == null) {
        if(!((CategoryParent) getChild(groupPosition, childPosition)).isParent()){
            ...
            if( ((CategoryParent) getChild(groupPosition, childPosition)).getID()==
            ((CategoryParent) getChild(groupPosition, childPosition)).getParentID()){
                String childTexts = ((CategoryParent) getChild(groupPosition, childPosition)).getAlias();
