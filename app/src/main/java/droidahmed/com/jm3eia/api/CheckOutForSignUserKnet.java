...
public class CheckOutForSignUserKnet extends AsyncTask<String, Void, ResponseOfCheckOut> {

	private final static String URL = "https://jm3eia.com/API/ar/checkout?nostyle";
	private ProgressDialog dialog;
	private OnProcessCompleteListener callback;
	private Context context;

	public CheckOutForSignUserKnet(Context context, OnProcessCompleteListener cb) {
