...
public class AllUserProduct extends AsyncTask<String, Void, ProductListItem> {

	private final String URL = Keys.BASE_URL + "offer/u/";
	private ProgressDialog dialog;
	private OnProcessCompleteListener callback;
	private Context context;

	public AllUserProduct(Context context, OnProcessCompleteListener cb) {
