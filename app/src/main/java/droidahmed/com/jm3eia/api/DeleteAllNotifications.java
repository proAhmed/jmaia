...
public class DeleteAllNotifications extends AsyncTask<String, Void, ResultWS> {

	private final static String URL = Keys.BASE_URL
			+ "profile/delete_notifications";

	private ProgressDialog dialog;
	private OnProcessCompleteListener callback;
	private Context context;

	public DeleteAllNotifications(Context context, OnProcessCompleteListener cb) {
	...
	protected void onPreExecute() {
		this.dialog.setMessage(context.getResources().getString(
				R.string.loading_remove_alerts));
