 ...
 */
public class SearchProducts extends AsyncTask<String,Void,MainApi > {
    private ProgressDialog dialog;
    private final static String URL =  "https://jm3eia.com/API/ar/product/search?q=";
    private OnProcessCompleteListener callback;
    private Context context;
    String finalUrl;
    public SearchProducts(Context context, OnProcessCompleteListener cb,String word,String pag) {
