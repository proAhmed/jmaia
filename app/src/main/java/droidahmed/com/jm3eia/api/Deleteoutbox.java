...
public class Deleteoutbox extends AsyncTask<String, Void, WSResult> {

	private final static String URL = Keys.BASE_URL + "message/deleteoutbox";
	private ProgressDialog dialog;
	private OnProcessCompleteListener callback;
	private Context context;

	public Deleteoutbox(Context context, OnProcessCompleteListener cb) {
	...
	protected void onPreExecute() {
		this.dialog.setMessage(context.getResources().getString(
				R.string.loading_remove_message));
