...
public class DeleteNotification extends AsyncTask<String, Void, ResultWS> {

	private final static String URL = Keys.BASE_URL
			+ "profile/delete_notification";

	private ProgressDialog dialog;
	private OnProcessCompleteListener callback;
	private Context context;

	public DeleteNotification(Context context, OnProcessCompleteListener cb) {
