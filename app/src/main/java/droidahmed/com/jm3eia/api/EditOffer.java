...
public class EditOffer extends AsyncTask<AddOfferInput, Void, AddOfferModel> {

	private final static String URL = Keys.BASE_URL + "profile/editoffer/";
	private ProgressDialog dialog;
	private OnProcessCompleteListener callback;
	private Context context;

	public EditOffer(Context context, OnProcessCompleteListener cb) {
	...
	public static String makeRequest(AddOfferInput obj) throws Exception {
		...
		HttpPost httpost = new HttpPost(URL + obj.getOfferID());
