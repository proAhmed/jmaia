...
public class AddFavorit extends AsyncTask<String, Void, AddDeleteFavorit> {

	private final static String URL = Keys.BASE_URL + "favorite/add";

	private ProgressDialog dialog;
	private OnProcessCompleteListener callback;
	private Context context;

	public AddFavorit(Context context, OnProcessCompleteListener cb) {
