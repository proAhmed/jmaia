...
public class ReportWS extends AsyncTask<String, Void, WSResult> {

	private final static String URL = Keys.BASE_URL + "offer/report/";
	private ProgressDialog dialog;
	private OnProcessCompleteListener callback;
	private Context context;

	public ReportWS(Context context, OnProcessCompleteListener cb) {
	...
	protected void onPreExecute() {
		this.dialog.setMessage(context.getResources().getString(
				R.string.loading_report_product));
	...
	public static String makeRequest(String ID) throws Exception {
